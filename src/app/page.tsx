...
const perks = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    desc: 'Every asset on our platform is verified by our team to ensure our highest quality standards. No happy? We offer a 30-day refund guarantee.'
  },
  {
    name: 'For the Planet',
    Icon: Leaf,
      ...
      <MaxWidthWrapper >
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className="mt-6 text-xl max-w-prose text-muted-foreground">
            Welcome to Hippo UI. Every asset on our platform is verified
